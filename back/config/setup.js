...
con.connect(function(err) {
  ...
  var historyTable = "CREATE TABLE IF NOT EXISTS history (id INT(5) NOT NULL AUTO_INCREMENT PRIMARY KEY, user_id int(11) NOT NULL, visitor_id int(11) NOT NULL, date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)";
