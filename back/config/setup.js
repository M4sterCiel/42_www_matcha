...
con.connect(function(err) {
  ...
  var userTable =
    "CREATE TABLE IF NOT EXISTS users (id INT(5) NOT NULL AUTO_INCREMENT PRIMARY KEY, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, city VARCHAR(255), latitude FLOAT(9) NULL DEFAULT NULL, longitude FLOAT(9) NULL DEFAULT NULL, `key` VARCHAR(255), password_key VARCHAR(255), status TINYINT(1) NOT NULL DEFAULT 0)";
